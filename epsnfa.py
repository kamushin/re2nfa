...
def union(s1,t1,s2,t2):
    ...
    start_state = incCapacity()
    end_state = incCapacity()

    addEdge(start_state, epssymbol, s1)
    addEdge(start_state, epssymbol, s2)
    addEdge(t1, epssymbol, end_state)
    addEdge(t2, epssymbol, end_state)
...
def clo(s,t):
    ...
    addEdge(start_state, epssymbol, s)
    addEdge(start_state, epssymbol, end_state)
    addEdge(t, epssymbol, s)
    addEdge(t, epssymbol, end_state)
    
    st[0], st[1] = start_state, end_state
